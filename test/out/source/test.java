...
public class test extends PApplet {
    ...
    //processingソケット通信
    //processingソケット通信
      //(extrapixel/gif-animation at 3.0)をダウンロードし解凍してprocessingのlibrariesフォルダにgifAnimationをコピー
...
public void mouseReleased(){
    msg_speedX = (pull_X - mouseX)*0.5f;
    msg_speedY = (pull_Y - mouseY)*0.5f;
    dragging = 0;
}
...
public void startscreen1(){         //画面バウンド
    camera(0,10,500, 0, 0, 0, 0, 0, -1);
    hint(DISABLE_DEPTH_TEST);
    fill(0);
    textSize(54);
